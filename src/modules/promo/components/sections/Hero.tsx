          ...
          <div className="relative bg-linear-to-b from-gray-700 via-gray-900 to-black p-1.5 rounded-[2.5rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] ring-1 ring-white/20">
            ...
            <div className="w-full h-full bg-surface-container-lowest rounded-[2.2rem] overflow-hidden relative aspect-9/19">
              {/*
                ...
                iba una foto de stock de flores desenfocadas, así que la portada
                no tenía nada que ver con lo que se reproduce al tocar —se
                anunciaba una cosa y sonaba otra.
              */}
              <YouTubeFacade videoId={LANDING_VIDEOS.hook} title="Video 1 Hook">
                <span className="absolute bottom-4 left-4 right-4 flex items-center gap-3 rounded-xl border border-white/10 bg-black/60 p-3 backdrop-blur-xl">
                  ...
                  <span className="flex-1 text-left">
                    <span className="block font-label-md text-white text-sm truncate">Video 1</span>
                    <span className="block font-label-sm text-gray-300 text-xs truncate">Toca para ver</span>
                  </span>
                </span>
              </YouTubeFacade>
            </div>
